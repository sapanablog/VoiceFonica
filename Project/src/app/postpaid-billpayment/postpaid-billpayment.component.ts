...
localStorage.setItem('key','9980598756')
this.activeplans.phno=8980598756 //parseInt(localStorage.getItem('key'))
this.activeplans.plan_id=3//parseInt(localStorage.getItem('postactiveid'))
this.activeplans.date=new Date() //new Date(localStorage.getItem('postactivedate'))
